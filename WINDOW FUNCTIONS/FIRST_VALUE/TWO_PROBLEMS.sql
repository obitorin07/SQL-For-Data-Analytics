...
SELECT FIRST_NAME  , 
		LAST_NAME ,
		SALARY,
		FIRST_VALUE(FIRST_NAME) OVER(ORDER BY SALARY)AS LOWEST_SAL
		FROM employees
...
SELECT	FIRST_NAME,LAST_NAME  ,
		salary , 
		department_name,
		FIRST_VALUE(CONCAT(FIRST_NAME , ' ' ,LAST_NAME )) OVER(PARTITION BY DEPARTMENT_NAME ORDER BY SALARY) AS LOW_SAL
