...
SELECT * FROM SALES AS S JOIN MEMBERS AS C ON C.CUSTOMER_ID = S.CUSTOMER_ID JOIN MENU AS M ON M.PRODUCT_ID = S.PRODUCT_ID;
-- USE LEFT ALSO
SELECT * FROM SALES AS S LEFT JOIN MEMBERS AS C ON C.CUSTOMER_ID = S.CUSTOMER_ID LEFT JOIN MENU AS M ON M.PRODUCT_ID = S.PRODUCT_ID;
